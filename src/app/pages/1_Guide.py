...
text = '''
Upload Data
You can import multiples csv files, it’s suggested that the file name contains information about the sample, because it will be incorporated as a column on he concatenated table.
